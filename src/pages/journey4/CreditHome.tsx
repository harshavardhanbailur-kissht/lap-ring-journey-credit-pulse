...
import { multiPhaseUser, getScoreLabel } from '../../data/mockData';
  ...
  return (
    <div className="min-h-screen bg-[var(--color-ring-light-bg)]">
      ...
      <div className="p-4 space-y-4 content-with-nav">
        {/* LAP Application In Progress Banner */}
        <div className="bg-gradient-to-br from-[var(--color-ring-blue)] to-[var(--color-ring-dark-blue)] text-white p-4 rounded-xl">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
              <span className="text-2xl">📋</span>
            </div>
            <div className="flex-1">
              <p className="font-semibold">LAP Application In Progress</p>
              <p className="text-sm opacity-90">Track your application status</p>
            </div>
            <button
              onClick={() => navigate('/journey4/initial-approval')}
              className="bg-white text-[var(--color-ring-blue)] px-4 py-2 rounded-lg font-semibold text-sm"
            >
              View
            </button>
          </div>
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            <span className="text-sm text-[var(--color-text-secondary)]">Track Journey</span>
          </button>
          <button
            onClick={() => navigate('/journey4/initial-approval')}
            className="flex-1 bg-white rounded-xl p-4 text-center"
          >
            ...
            <span className="text-sm text-[var(--color-text-secondary)]">Application</span>
          </button>
        </div>
      </div>
