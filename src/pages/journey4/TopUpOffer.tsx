...
import { topUpEligibilityData } from '../../data/mockData';

export default function TopUpOffer() {
  const navigate = useNavigate();
  const [showConfirmation, setShowConfirmation] = useState(false);
  const topUpData = topUpEligibilityData;
        ...
        <div className="p-4 flex items-center justify-center min-h-[calc(100vh-64px)]">
          <div className="bg-white rounded-xl p-6 text-center max-w-md w-full">
            ...
            <p className="text-[var(--color-text-secondary)] mb-4">
              Your interest in the top-up offer has been logged. Our team will contact you
    ...
    <div className="min-h-screen bg-[var(--color-ring-light-bg)]">
      ...
      <header className="bg-[var(--color-ring-dark-blue)] text-white p-4">
        <div className="flex items-center justify-between">
          ...
          <h1 className="font-semibold">Top-up Offer</h1>
          <div className="w-6" />
        </div>
      </header>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-gradient-to-br from-[var(--color-ring-blue)] to-[var(--color-ring-dark-blue)] text-white rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="font-bold text-lg">Internal Top-up Available</p>
            </div>
          </div>
          <p className="text-sm opacity-90 mb-2">
            Congratulations! Based on your excellent repayment history over the past 6 months,
            you're now eligible for additional funds.
          </p>
          <p className="text-sm opacity-90">
            Current LAP loan: ₹30 Lakhs (disbursed Jul 2024) • You can get up to ₹10 Lakhs more!
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl p-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between py-2 border-b border-gray-100">
              ...
              <span className="font-bold text-green-600">Up to ₹{(topUpData.amount / 100000).toFixed(0)} Lakhs</span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-100">
              <span className="text-[var(--color-text-secondary)]">Interest Rate</span>
              <span className="font-semibold text-green-600">Same as existing LAP (9.5%)</span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-100">
        ...
        <div className="bg-white rounded-xl p-4">
          ...
          <ul className="space-y-2">
            {topUpData.benefits.map((benefit, i) => (
        ...
        <div className="text-center pt-4 border-t border-gray-200">
          <p className="text-sm text-[var(--color-text-muted)]">
            End of Journey 4 (Multi-Phase Application Flow)
          </p>
          <button
            onClick={() => navigate('/')}
